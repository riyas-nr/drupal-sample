...
class __TwigTemplate_625487dc8d190f43cf91aaeb390048c780287f69409955b45e4cfe82c8861436 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-tips__item--id-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 50), 50, $this->source)))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/olivero/templates/filter/filter-tips.html.twig", "C:\\xampp\\htdocs\\drupal-dev\\drupal-dev\\core\\themes\\olivero\\templates\\filter\\filter-tips.html.twig");
    }
